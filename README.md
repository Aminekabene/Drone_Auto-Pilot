...
<div align="center">
  <a href="https://github.com/Aminekabene/Drone_Auto-Pilot">
    <img src="./helper/droneIcon.jpg" alt="Logo" width="100" height="100">
  </a>

<h3 align="center">AI Tracking Drone</h3>

  <p align="center">
    This AI drone love you so much that just like a small puppy it won't stop following you. ;)
    <br />
...
As you can see, the Drone can detect and track multiple objects in a frame. Once a target is selected, the drone will track the selected object relative to its position in the frame.
